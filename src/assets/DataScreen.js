	...
	screenShow:{
		...
		settlement:{
			bts:[
				...
				{prop:"open_id",lable:"用户ID"},
				{prop:"username",lable:"用户昵称"},
				{prop:"deal_type",lable:"结算方式",type:"keyvalue",child:{"1":"买断","2":"分成","3":"预付金+分成"}},
				{prop:"primary_fee",lable:"纯分成金额",type:"price"},
				{prop:"gain_share_rate",lable:"收益加成比",type:"baifen"},
				{prop:"profit_fee",lable:"加成金额",type:"price"},
				{prop:"balance_fee",lable:"分成结算收益",type:"price"},
				{prop:"advance_payment",lable:"预付金额",type:"price"},
				{prop:"advance_payment_income",lable:"预付金收益",type:"price"},
				{prop:"advance_payment_total_income",lable:"预付金累计",type:"price"},
			],
			action:{
				is_hidden:true,
				morebtns:{
		...
		embodyRecord:{
			bts:[
				...
				{prop:'username',lable:'用户昵称',type:"url",id:"open_id",url:"/userManager/userBaseInfo/userBaseInfoDetail?open_id="},
				{lable:"提现金额",prop:"cash_money",type:"price"},
