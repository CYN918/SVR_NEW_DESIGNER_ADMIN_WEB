	...
	screenShow:{
		...
		settlement:{
			bts:[
				...
				{prop:"open_id",lable:"用户ID"},
				{prop:"username",lable:"用户昵称"},
				{prop:"deal_type",lable:"结算方式",type:"keyvalue",child:{"1":"买断型","2":"分成型","3":"预付金+分成"}},
				{prop:"primaray_fee",lable:"纯分成金额"},
				{prop:"gain_share_rate",lable:"收益加成比"},
				{prop:"profit_fee",lable:"加成金额"},
				{prop:"balance_fee",lable:"分成结算收益"},
				{prop:"advance_payment",lable:"预付金额"},
				{prop:"advance_payment_income",lable:"预付金收益"},
				{prop:"advance_payment_total_income",lable:"预付金累计"},
			],
			action:{
				is_hidden:true,
				morebtns:{
