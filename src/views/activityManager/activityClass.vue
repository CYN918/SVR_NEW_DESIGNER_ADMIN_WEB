		...
		data() {
			return {
				...
				tableConfig: {
					...
					currentpage:1,
					pagesize:10,
					list: DataScreen.screenShow.activityClass.bts,
				},
				tableData: [],
				tableAction: DataScreen.screenShow.activityClass.action,
				detailData: "",
				filterFields:DataScreen.screen.activityClass.filterFields,
				IsDetail:1,
				roles:{},
				menulist:'',
			}
