	...
	export default {
		...
		data() {
			return {
				...
				bts: DataScreen.screenShow.commentManager.bts,
				defaultbts: DataScreen.screenShow.commentManager.defaults,
				tableAction: DataScreen.screenShow.commentManager.action,
				filterFields: DataScreen.screen.commentManager.filterFields,
				screenShowDataChange: "",
				IsDetail: false,
				commonTopData: {
					"pageName": "commentManager",
					"commonleftbtn": [{
						name: "筛选",
						id: "left1",
						url: ""
