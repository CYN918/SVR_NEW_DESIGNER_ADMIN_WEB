	...
	export default {
		...
		data() {
			return {
				...
				tableConfig: {
					...
					currentpage:1,
					pagesize:10,
					list: DataScreen.screenShow.hotWordSearch.bts,
				},
				tableData: [],
				tableAction: DataScreen.screenShow.hotWordSearch.action,
				detailData: "",
				filterFields:DataScreen.screen.hotWordSearch.filterFields,
				IsDetail:1,
				roles:{},
				menulist:'',
			}
		...
		methods: {
			...
			getData(pg) {
				...
				this.api.hotwordlist(data).then((da) => {
