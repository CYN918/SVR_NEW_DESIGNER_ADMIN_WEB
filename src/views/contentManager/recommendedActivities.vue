	...
	export default {
		...
		data() {
			return {
				...
				tableConfig: {
					...
					currentpage:1,
					pagesize:10,
					list: DataScreen.screenShow.recommendedActivities.bts,
				},
				tableData: [],
				tableAction: DataScreen.screenShow.recommendedActivities.action,
				detailData: "",
				filterFields:DataScreen.screen.recommendedActivities.filterFields,
				IsDetail:1,
				roles:{},
				menulist:'',
			}
		...
		methods: {
			...
			getData(pg) {
				...
				this.api.recommendactivitylist(data).then((da) => {
