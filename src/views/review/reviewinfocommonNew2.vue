    ...
    <div class="box">
        <div class="box_message">
            <ul>
                ...
                <li>
                    ...
                    <span class="right" style="color:#000000;"><i></i>{{apply_info.status!=2?'已选标':'待选标'}}</span>
                </li>
            </ul>
        </div>
        <div class="box_process">
            ...
            <div class="box_process_content nsh_00">
				...
				<div class="nsh_01">
					<span class="nsh_02">{{apply_info.status!=2?'已选标':'待选标'}}</span>
					<div class="nsh_03">						
						项目报名审核：
						<div class="nsh_05" v-if="apply_info.status==2">
						...
						<div v-else class="nsh_04">
							{{apply_info.select_admin_name +" "+apply_info.bidding_time}}
						</div>
					</div>
				...
				<div class="nsh_12" v-if="apply_info.status!=2">
					<div class="nsh_14">
						<span class="nsh_13">中标用户ID</span>{{apply_info.user_id}}
					</div>
					<div class="nsh_14">
						<span class="nsh_13">中标用户名称</span>{{apply_info.username}}
					</div>
				</div>
            </div>
